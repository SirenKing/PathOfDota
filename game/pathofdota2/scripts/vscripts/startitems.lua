...
local startitems = {
	-- item_patreon_7 = {},
	-- item_ability_gem_vortex = { amt = 1 },
	-- item_ability_gem_castoncrit = { amt = 1 },
	-- item_aghanims_shard = { amt = 1 },
	-- item_lesser_crit= { amt = 1 },
	-- item_travel_boots = {amt=20, cd= 100},
}
local bonusabilities = {
	ability_update_modifiers = { lvl = 1, nokey = true, hidden = true },
